...
const SupplierKPICard = ({ title, value, icon: Icon, colorClass, trend }) => {
  return (
    <div className="bg-white dark:bg-nexus-bg p-5 rounded-2xl border border-slate-200 dark:border-[#1F2937] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
