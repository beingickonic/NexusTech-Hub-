...
const RecentActivity = () => {
  const activities = [
    { id: 1, title: 'New Order Received', desc: 'ORD-8821 for 2x iPhone 15 Pro', time: '10 mins ago', icon: Package, color: 'text-orange-500 bg-orange-50 dark:bg-orange-500/10' },
    ...
    { id: 3, title: 'Payment Received', desc: 'Finance cleared Inv-992 for $4,500', time: '3 hours ago', icon: DollarSign, color: 'text-green-500 bg-green-50 dark:bg-green-500/10' },
    { id: 4, title: 'Product Approved', desc: 'Samsung Galaxy S24 is now live', time: '5 hours ago', icon: CheckCircle, color: 'text-purple-500 bg-purple-50 dark:bg-purple-500/10' },
  ];
