...
const RecentActivityFeed = () => {
  const activities = [
    ...
    { id: 2, title: 'Stock Adjustment', desc: 'Manual adjustment for iPhone 15 Pro (+5)', time: '1 hour ago', icon: RefreshCw, color: 'text-nexus-primary bg-nexus-primary/10 dark:bg-nexus-primary/10' },
    { id: 3, title: 'Damaged Goods Reported', desc: '2x Samsung S24 Ultra marked as damaged', time: '3 hours ago', icon: AlertTriangle, color: 'text-nexus-error bg-nexus-error/5 dark:bg-nexus-error/10' },
    { id: 4, title: 'Order Picked', desc: 'Order #ORD-8821 ready for dispatch', time: '5 hours ago', icon: CheckCircle, color: 'text-nexus-success bg-nexus-success/5 dark:bg-nexus-success/10' },
  ];
