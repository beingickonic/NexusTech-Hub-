...
const OrderSummary = ({ cartItems, cartSummary }) => {
  return (
    <div className="bg-white/80 dark:bg-nexus-card/80 backdrop-blur-md border border-nexus-border rounded-3xl p-6 shadow-xl sticky top-24">
      <h3 className="text-xl font-bold text-nexus-heading mb-6">Review Order</h3>
      ...
      <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 mb-6 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
        {cartItems.map(item => (
          <div key={item.product_id} className="flex gap-3">
            ...
            <div className="font-semibold text-sm text-nexus-heading text-right">
      ...
      <div className="space-y-3 text-sm text-nexus-muted">
        ...
        <div className="flex justify-between text-lg">
          <span className="font-bold text-nexus-heading">Total to Pay</span>
