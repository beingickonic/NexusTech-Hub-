...
const AuthLayout = ({ children, title, subtitle, illustration }) => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#F8FAFC] dark:bg-[#020617] transition-colors duration-300">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-7/12 relative overflow-hidden bg-[#0F172A]">
        ...
        <div className="relative z-10 flex flex-col justify-end p-16 w-full text-white">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 leading-tight">
              Premium Tech.<br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-300">Elevated Experience.</span>
            </h2>
