        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-200 dark:divide-slate-700/50 text-sm">
            {isLoading ? (
              ...
              <tr>
                <td colSpan="6" className="px-6 py-12 text-center text-nexus-textSecondary dark:text-nexus-textSecondary">
                  No products found.
                </td>
              </tr>
            ) : (
                ...
                <tr key={product.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-white dark:bg-nexus-surface overflow-hidden flex-shrink-0 border border-slate-100 dark:border-nexus-border p-1 flex items-center justify-center">
                        {product.image_url ? (
                         (() => {
                      ...
                      <div>
                        ...
                        <p className="text-xs text-nexus-textSecondary dark:text-nexus-textSecondary mt-0.5">SKU: {product.sku}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    {product.availability === true ? (
                      ...
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-nexus-textSecondary border border-slate-200 dark:border-slate-600">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Link to={`/admin/products/edit/${product.id}`} className="p-2 text-nexus-textSecondary hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-500/10 rounded-lg transition-colors">
                        <Edit size={16} />
                      </Link>
                      <button onClick={() => handleDelete(product.id)} className="p-2 text-nexus-textSecondary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </td>
