...
const OrderCard = ({ order }) => {
  ...
  return (
    <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-slate-200 dark:border-nexus-border rounded-2xl p-6 hover:shadow-lg transition-shadow">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-nexus-textSecondary dark:text-nexus-textSecondary text-sm">Placed on {date}</p>
          </div>
        </div>

        <div className="flex items-center justify-between md:justify-end gap-6 flex-1">
          <div>
            <p className="text-sm text-nexus-textSecondary dark:text-nexus-textSecondary mb-1">Total Amount</p>
            <p className="font-bold text-slate-900 dark:text-white">{formatCurrency(order.total_amount)}</p>
          </div>
          
          <div>
            <p className="text-sm text-nexus-textSecondary dark:text-nexus-textSecondary mb-1">Status</p>
