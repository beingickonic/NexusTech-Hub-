    ...
    <div className="animate-fade-in space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-2xl p-6 shadow-sm flex flex-col items-center">
            <div className="w-32 h-32 rounded-full bg-slate-100 dark:bg-nexus-bg border-4 border-white dark:border-[#0C1220] shadow-lg flex items-center justify-center mb-4 relative overflow-hidden group">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">{user?.full_name || 'Business Name'}</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900 dark:text-white">+254 700 000000</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-2xl p-6 shadow-sm">
            <h3 className="font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
              <Building2 size={18} className="text-orange-500" /> Business Details
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-xs font-medium text-nexus-textSecondary">Legal Business Name</label>
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="Nexus Vendor Ltd" />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-medium text-nexus-textSecondary">KRA PIN / Tax ID</label>
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="P051234567Z" />
              </div>
              <div className="space-y-1 md:col-span-2">
                <label className="text-xs font-medium text-nexus-textSecondary">Physical Address</label>
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="123 Biashara Street, Nairobi, Kenya" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="Equity Bank" />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-medium text-nexus-textSecondary">Branch</label>
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="Upperhill" />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <input type="text" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-nexus-primary dark:text-white" defaultValue="08101000000" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-2xl p-6 shadow-sm">
            <h3 className="font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
              <FileText size={18} className="text-green-500" /> Compliance Documents
            </h3>
            <div className="p-4 rounded-xl border border-dashed border-slate-300 dark:border-nexus-border bg-slate-50 dark:bg-white/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <FileText size={24} className="text-nexus-textSecondary" />
                <div>
                  <p className="font-medium text-sm text-slate-900 dark:text-white">Business Registration Certificate</p>
