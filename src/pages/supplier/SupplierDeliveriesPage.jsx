  ...
  return (
    <div className="animate-fade-in space-y-6 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-nexus-heading">Deliveries</h1>
            ...
            <tbody className="divide-y divide-nexus-border dark:divide-nexus-card">
              <tr className="hover:bg-nexus-surface dark:hover:bg-nexus-hover transition-colors">
                <td className="px-6 py-4">
                  <p className="font-medium text-nexus-heading">ORD-8820</p>
                  <p className="text-xs text-nexus-textSecondary flex items-center gap-1"><Truck size={12} /> Nexus Logistics</p>
                </td>
                <td className="px-6 py-4 text-nexus-muted">TRK-10928374</td>
                <td className="px-6 py-4 text-nexus-muted">Today, 08:00 AM</td>
                <td className="px-6 py-4 text-nexus-muted">Tomorrow</td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-right">
                  <button className="text-nexus-primary hover:text-nexus-primary font-medium text-xs">View Status</button>
                </td>
              </tr>
              <tr className="hover:bg-nexus-surface dark:hover:bg-nexus-hover transition-colors">
                <td className="px-6 py-4">
                  <p className="font-medium text-nexus-heading">ORD-8815</p>
                  <p className="text-xs text-nexus-textSecondary flex items-center gap-1"><Truck size={12} /> FedEx Express</p>
                </td>
                <td className="px-6 py-4 text-nexus-muted">FDX-99881122</td>
                <td className="px-6 py-4 text-nexus-muted">Yesterday</td>
                <td className="px-6 py-4 text-nexus-muted">Today</td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-right">
                  <button className="text-nexus-primary hover:text-nexus-primary font-medium text-xs">Proof of Delivery</button>
                </td>
              </tr>
            </tbody>
          </table>
