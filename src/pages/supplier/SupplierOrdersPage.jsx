  ...
  return (
    <div className="animate-fade-in space-y-6 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-nexus-heading">Orders</h1>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-nexus-border dark:divide-nexus-card">
              <tr className="hover:bg-nexus-surface dark:hover:bg-nexus-hover transition-colors">
                <td className="px-6 py-4 font-medium text-nexus-heading">ORD-8821</td>
                <td className="px-6 py-4 text-nexus-muted">Michael Johnson</td>
                <td className="px-6 py-4 text-nexus-muted">2 Items</td>
                <td className="px-6 py-4 text-nexus-muted">Today, 10:30 AM</td>
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  <button className="text-white bg-nexus-success hover:bg-nexus-success px-3 py-1.5 rounded-lg font-medium text-xs flex inline-flex items-center gap-1 transition-colors">
                    <Check size={14} /> Accept
                  </button>
                </td>
              </tr>
              <tr className="hover:bg-nexus-surface dark:hover:bg-nexus-hover transition-colors">
                <td className="px-6 py-4 font-medium text-nexus-heading">ORD-8822</td>
                <td className="px-6 py-4 text-nexus-muted">Sarah Williams</td>
                <td className="px-6 py-4 text-nexus-muted">1 Item</td>
                <td className="px-6 py-4 text-nexus-muted">Yesterday, 02:15 PM</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-info/10 text-info dark:bg-info/100/20 dark:text-info">
                    Packing
                  </span>
                </td>
                <td className="px-6 py-4 text-right space-x-2">
                  <button className="text-white bg-nexus-primary hover:bg-nexus-primary-hover px-3 py-1.5 rounded-lg font-medium text-xs flex inline-flex items-center gap-1 transition-colors">
