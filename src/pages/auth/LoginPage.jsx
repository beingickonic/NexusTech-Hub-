      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <input 
            ...
            className="w-full bg-[#F8FAFC] dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input 
              ...
              className="w-full bg-[#F8FAFC] dark:bg-nexus-bg border border-slate-200 dark:border-nexus-border rounded-xl pl-4 pr-12 py-3 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              placeholder="••••••••"
            />
            <button 
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-nexus-textSecondary hover:text-slate-600 dark:hover:text-gray-200 transition-colors"
            >
        ...
        <div className="relative flex items-center py-2">
          <div className="flex-grow border-t border-slate-200 dark:border-nexus-border"></div>
          <span className="flex-shrink-0 mx-4 text-nexus-textSecondary text-sm">or continue with</span>
          <div className="flex-grow border-t border-slate-200 dark:border-nexus-border"></div>
        </div>

        <div className="grid grid-cols-2 gap-4">
          <button type="button" className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 dark:border-nexus-border rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-slate-700 dark:text-gray-300 font-medium text-sm">
